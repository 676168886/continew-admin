...
public class LoginHelper {
    ...
    public static String login(LoginUser loginUser) {
        ...
        //MYP开发阶段设置成一个固定的token
        String tokenValue = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJsb2dpblR5cGUiOiJsb2dpbiIsImxvZ2luSWQiOjEsInJuU3RyIjoiSVlNNkU2REE3YlNrN3pPdW83NWlyUzhWMDJsVGpqTEgifQ.U2gfX02lpTNCXJxx-QZuvPN7cX9shtmIs7IGCDxKNYQ";
        System.out.println("MYP增加【登录=测试模式】使用默认token："+tokenValue);
    ...
    public static LoginUser getLoginUser() throws NotLoginException {
        ...
        SaHolder.getStorage().set(CacheConstants.LOGIN_USER_KEY, loginUser);
        System.out.println("用户登录信息："+ JSONUtil.toJsonStr(loginUser));
        return loginUser;
    }
